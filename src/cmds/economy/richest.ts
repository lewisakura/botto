...
async function exec(ctx: CommandContext) {
    ...
    const top10Wallets = wallets.sort((a, b) => Number(b.onHand + b.balance - (a.onHand + a.balance))).slice(0, 10);
    ...
    return ctx.reply(`**Top 10 Richest Users**\n\n${top10}`);
}

export default {
    name: 'richest',
    description: 'Get the top 10 Bottobux holders.',
    usage: null,
